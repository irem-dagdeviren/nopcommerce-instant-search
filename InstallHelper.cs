...
namespace Nop.Plugin.InstantSearch
{
    ...
    {
        private static readonly Dictionary<string, Dictionary<string, IEnumerable<string>>> _supportedWidgetZonesByPluginAndThemePerFiles = new Dictionary<string, Dictionary<string, IEnumerable<string>>>();
        private static readonly Dictionary<string, IEnumerable<string>> _supportedWidgetZonesByPluginAndTheme = new Dictionary<string, IEnumerable<string>>();
            ...
            string themeName)
        {
            ...
            if (InstallHelper._supportedWidgetZonesByPluginAndTheme.ContainsKey(key))
                return InstallHelper._supportedWidgetZonesByPluginAndTheme[key];
            ...
            {
                if (!InstallHelper._supportedWidgetZonesByPluginAndTheme.ContainsKey(key))
                    InstallHelper._supportedWidgetZonesByPluginAndTheme.Add(key, (IEnumerable<string>) widgetZonesForTheme);
            }
            ...
            string themeName)
        {
            ...
            if (!InstallHelper._supportedWidgetZonesByPluginAndThemePerFiles.ContainsKey(str))
            {
            ...
            return InstallHelper._supportedWidgetZonesByPluginAndThemePerFiles[str];
        }
            ...
            string pluginThemeKey)
        {
            ...
            if (InstallHelper._supportedWidgetZonesByPluginAndThemePerFiles.ContainsKey(pluginThemeKey))
                return;
            InstallHelper._supportedWidgetZonesByPluginAndThemePerFiles.Add(pluginThemeKey, dictionary1);
        }
