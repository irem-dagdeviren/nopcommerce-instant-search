...
// Type: Nop.Plugin.InstantSearch.Dotless.Parser.Infrastructure.MimeTypeLookup
...
namespace Nop.Plugin.InstantSearch.Dotless.Parser.Infrastructure
{
  ...
  {
    private static readonly Dictionary<string, string> _mappings = new Dictionary<string, string>(2000, (IEqualityComparer<string>) StringComparer.InvariantCultureIgnoreCase)
    {
      {
        ".ez",
    ...
    public string ByFilename(string filename)
    {
      ...
      string str;
      return !string.IsNullOrEmpty(key) && MimeTypeLookup._mappings.TryGetValue(key, out str) ? str : (string) null;
    }
  }
}
