...
// Type: Nop.Plugin.InstantSearch.Dotless.Parser.Functions.SaturationFunction
...
namespace Nop.Plugin.InstantSearch.Dotless.Parser.Functions
{
  public class SaturationFunction : SaturateFunction
  {
    ...
    {
      this.WarnNotSupportedByLessJS("saturation(color, number)", "saturate(color, number) or its opposite desaturate(color, number),");
