...
// Type: Nop.Plugin.InstantSearch.Dotless.Parser.Functions.LightnessFunction
...
namespace Nop.Plugin.InstantSearch.Dotless.Parser.Functions
{
  public class LightnessFunction : LightenFunction
  {
    ...
    {
      this.WarnNotSupportedByLessJS("lightness(color, number)", "lighten(color, number) or its opposite darken(color, number),");
