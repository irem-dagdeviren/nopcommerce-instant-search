...
// Type: Nop.Plugin.InstantSearch.Dotless.Parser.Functions.TintFunction
...
namespace Nop.Plugin.InstantSearch.Dotless.Parser.Functions
{
  public class TintFunction : MixFunction
  {
    protected override Node Evaluate(Env env)
    {
      ...
      return (Node) this.Mix(new Color((double) byte.MaxValue, (double) byte.MaxValue, (double) byte.MaxValue), (Color) this.Arguments[0], ((Number) this.Arguments[1]).Value);
    }
  }
}
